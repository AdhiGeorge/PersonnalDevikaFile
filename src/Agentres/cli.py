...
from Agentres.file_manager.file_manager import FileManager
from Agentres.workflow.workflow_manager import WorkflowManager, WorkflowState
...
class CLI:
    ...
    def _load_env(self):
        ...
        load_dotenv()
        logger.info(f"Loaded environment from {os.path.abspath('.env')}")
